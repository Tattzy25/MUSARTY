...
export default function Navigation() {
  ...
  return (
    <nav className="glass-strong border-b border-glass-border/30">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <div className="absolute inset-0 bg-neon-blue/20 rounded-lg blur-xl group-hover:bg-neon-blue/30 transition-all duration-300" />
              <div className="relative flex items-center justify-center w-10 h-10 glass rounded-lg neon-border">
                <Zap className="w-6 h-6 text-neon-blue group-hover:scale-110 transition-transform duration-300" />
              </div>
            </div>
            <div>
      ...
      {/* Cyber scan line */}
      <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-neon-blue to-transparent opacity-20" />
    </nav>
  );
}
